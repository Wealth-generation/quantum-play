// Minimal inline brand SVGs — no brand-icon package, no installs.
// Discord and X paths are identical to the glyphs in src/widgets/footer/footer.tsx.
// Google "G" is monochromatic currentColor (footer does not use Google).
// Used by: auth-modal (social auth placeholder block).
// Footer currently has its own copy — unify in a future cleanup pass.
