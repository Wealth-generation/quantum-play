      ...
      <div className="mx-auto max-w-7xl px-8 py-7">
        ...
        <div className="flex flex-wrap gap-10 md:gap-16">
          ...
          <div className="min-w-[120px]">
            <h3 className="mb-4 text-base font-medium uppercase text-text">
              About
            </h3>
            ...
            <div className="flex flex-wrap gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center rounded-md bg-surface-3 p-1.5 text-text-muted transition-colors hover:bg-border-2 hover:text-text"
                >
        ...
        {/* Copyright block */}
        <div className="mt-6 rounded-xl bg-bg p-6">
          <p className="text-xs font-light text-text-placeholder">
            {/* Placeholder — real legal/licensing copy to be provided by the business owner */}
            &copy; 2025 Quantum Play. Licensing and regulatory information to be
            provided.
          </p>
        </div>
      </div>
