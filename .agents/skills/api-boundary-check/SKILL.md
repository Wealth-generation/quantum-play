...
description: Use when changes touch browser API access, BFF route handlers, auth/session/token logic, API docs, or API boundary rules.
---
...
- `.Codex/rules/state-data-api-boundary.md`.
