---
name: review
description: Use after implementation and before pre-commit readiness for meaningful changes.
---
...
7. Check whether mapped durable docs changed or a relevant active task artifact docs-not-needed rationale exists for mapped/significant changes.
