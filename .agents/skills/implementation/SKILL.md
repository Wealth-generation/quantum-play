---
name: implementation
description: Use after the task goal, non-goals, and approved editable files are clear.
---
...
5. Create and switch to the task branch only after explicit user confirmation in Codex/Codex.
